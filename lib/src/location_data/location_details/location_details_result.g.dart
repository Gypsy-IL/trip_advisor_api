...
Map<String, dynamic> _$LocationDetailsResultToJson(
    ...
    <String, dynamic>{
      ...
      'latitude': JsonUtils.numToString(instance.latitude),
      'longitude': JsonUtils.numToString(instance.longitude),
      ...
      'rating': JsonUtils.numToString(instance.rating),
      'rating_image_url': instance.ratingImageUrl,
      'num_reviews': JsonUtils.numToString(instance.numReviews),
      'review_rating_count':
          instance.reviewRatingCount?.map((k, e) => MapEntry(k.toString(), e)),
      'subratings': instance.subratings
          ?.map((k, e) => MapEntry(k.toString(), e.toJson())),
      'photo_count': JsonUtils.numToString(instance.photoCount),
